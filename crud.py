...
def create_object(session: Session, title: str, location: str, latitude: str, longitude: str):
    db_objects = models.Object(title=title, location=location, latitude=latitude, longitude=longitude, time=dtt, date=dtd)
